...
const filesToUpdate = [
  ...
  'VisionMandate.jsx', 'GlobalLandscape.jsx', 'OpportunityCartography.jsx'
];

const targetStr = "<div style={{ paddingTop: '100px', paddingBottom: '4rem', background: 'var(--white)' }}>";
const replacementStr = '<div className="page-wrapper" style={{ background: \'var(--white)\' }}>';
